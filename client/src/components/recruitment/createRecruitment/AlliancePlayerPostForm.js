...
// class component
class AlliancePlayerPostForm extends React.Component {
  componentDidMount() {
...
// export component
AlliancePlayerPostForm = reduxForm({
  form: "createRecruitPost",
  enableReinitialize: true,
  validate,
})(AlliancePlayerPostForm);
AlliancePlayerPostForm = connect(mapStateToProps, {
  checkRecruitmentPost,
  clearRecruitmentCheck,
})(AlliancePlayerPostForm);
export default AlliancePlayerPostForm;
