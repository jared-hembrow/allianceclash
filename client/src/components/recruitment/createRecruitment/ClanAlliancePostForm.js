...
// class component
class ClanAlliancePostForm extends React.Component {
  componentDidMount() {
...
// export component
ClanAlliancePostForm = reduxForm({
  form: "createRecruitPost",
  enableReinitialize: true,
  validate,
})(ClanAlliancePostForm);

ClanAlliancePostForm = connect(mapStateToProps, {
  checkRecruitmentPost,
  clearRecruitmentCheck,
})(ClanAlliancePostForm);

export default ClanAlliancePostForm;
