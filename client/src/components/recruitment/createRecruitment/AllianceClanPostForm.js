...
// class component
class AllianceClanPostForm extends React.Component {
  componentDidMount() {
...
// export component
AllianceClanPostForm = reduxForm({
  form: "createRecruitPost",
  enableReinitialize: true,
  validate,
})(AllianceClanPostForm);
AllianceClanPostForm = connect(mapStateToProps, {
  checkRecruitmentPost,
  clearRecruitmentCheck,
})(AllianceClanPostForm);
export default AllianceClanPostForm;
